...
public interface Result<T> {
     ...
     */
    enum ErrorCode {OK, CONFLICT, NOT_FOUND, BAD_REQUEST, FORBIDDEN, INTERNAL_ERROR, NO_CONTENT}
 ...
 *
 */
class OkResult<T> implements util.Result<T> {
...
class ErrorResult<T> implements util.Result<T> {
